...
public class UpdatExpenseActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(getApplicationContext(),android.R.layout.simple_list_item_activated_1,typeExpense);
...
//cencle button
    ...
    public void AddDocumentMethod(View view) {
